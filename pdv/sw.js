const CACHE='nexcell-pdv-shell-v3';
const SHELL=[
 ...
 './modules/mobile-nav.js','./modules/mobile-nav.css','./modules/mobile-fixes.css','./modules/ui-policies.js','./modules/offline-store.js','./modules/offline-status.js','./modules/terminal-lock.js','./modules/cash-withdrawals.js',

...
async function render(){
 ...
 if(button)button.title=!contingencyReady?'Este navegador não conseguiu preparar o armazenamento local de contingência.':!online?'As vendas permitidas offline ficam salvas neste aparelho.':status.total?'Existem vendas locais aguardando sincronização.':'Conectado ao servidor.';
